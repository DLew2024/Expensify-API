...
public class TransactionConfiguration : IEntityTypeConfiguration<Transaction>
{
    ...
    public void Configure(EntityTypeBuilder<Transaction> builder)
    {
        ...
        builder.Property(transaction => transaction.AccountBalanceAfterTransaction)
            .IsRequired()
            .HasPrecision(18, 2);
        ...
        builder.Property(transaction => transaction.Tags)
            .IsRequired()
            .HasColumnType("text[]");
        ...
        builder.HasOne(transaction => transaction.Budget)
            .WithMany()
        ...
        builder.HasOne(transaction => transaction.LinkedTransaction)
            .WithOne()
            .HasForeignKey<Transaction>(
                transaction => transaction.LinkedTransactionId
            )
            .HasConstraintName(
                "fk_transactions_transactions_linked_transaction_id"
            )
            .OnDelete(DeleteBehavior.SetNull);
        ...
        builder.HasIndex(transaction => transaction.BudgetId)
        ...
        builder.HasIndex(transaction => transaction.LinkedTransactionId)
            .IsUnique()
