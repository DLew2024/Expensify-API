...
public class AccountTypeConfiguration : IEntityTypeConfiguration<AccountType>
{
    ...
    public void Configure(EntityTypeBuilder<AccountType> builder)
    {
        ...
        builder.Property(accountType => accountType.Description)
            .HasMaxLength(DatabaseLengths.Description);

        // One user can own many account types.
        builder.HasOne(accountType => accountType.User)
        ...
        builder.HasMany(accountType => accountType.Accounts)
        ...
        builder.HasIndex(accountType => new
        {
            accountType.UserId,
            accountType.Name
        })
