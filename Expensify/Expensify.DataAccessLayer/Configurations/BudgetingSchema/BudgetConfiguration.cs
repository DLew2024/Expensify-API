...
public class BudgetConfiguration : IEntityTypeConfiguration<Budget>
{
    ...
    public void Configure(EntityTypeBuilder<Budget> builder)
    {
        ...
        builder.Property(budget => budget.IsActive)
            .IsRequired();

        // Configures the shared-budget flag.
        builder.Property(budget => budget.IsShared)
            .IsRequired();
        ...
        builder.HasMany(budget => budget.BudgetCategories)
        ...
        builder.HasMany(budget => budget.Members)
