...
public class BudgetCategoryConfiguration : IEntityTypeConfiguration<BudgetCategory>
{
    ...
    public void Configure(EntityTypeBuilder<BudgetCategory> builder)
    {
        ...
        builder.Property(budgetCategory => budgetCategory.CategoryLimitAmount)
            .HasPrecision(18, 2);

        // One budget can contain many category assignments.
        builder.HasOne(budgetCategory => budgetCategory.Budget)
        ...
        builder.HasOne(budgetCategory => budgetCategory.Category)
        ...
        builder.HasIndex(budgetCategory => new
        {
        ...
        builder.HasIndex(budgetCategory => budgetCategory.CategoryId)
