    ...
    public partial class DML_SeedAccountTypes : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                {
                    {
                        new Guid("21d970f4-bda1-48c5-8b04-f38408508238"),
                        0L,
                    ...
                    {
                        new Guid("6f8332b7-cf15-4c41-b1b5-a85022859dd8"),
                        0L,
                        new Guid("00000000-0000-0000-0000-000000000000"),
                    ...
                    {
                        new Guid("81ac10c1-b977-45c9-a637-a00654ef07e7"),
                        0L,
                        new Guid("00000000-0000-0000-0000-000000000000"),
                    ...
                    {
                        new Guid("9de9f381-06e4-41f8-8269-f8cb76330cc9"),
                        0L,
                        new Guid("00000000-0000-0000-0000-000000000000"),
                    ...
                    {
                        new Guid("c524f6bf-b7da-4985-a1af-f76222dfc89c"),
                        0L,
                        new Guid("00000000-0000-0000-0000-000000000000"),
                        "Credit card or revolving credit account.",
                        true,
                        false,
                        true,
                        new Guid("00000000-0000-0000-0000-000000000000"),
                    ...
                    {
                        new Guid("f95a4632-e98f-4c9b-b831-b14447e3e308"),
                        0L,
                        new Guid("00000000-0000-0000-0000-000000000000"),
                        "Loan or other debt account.",
                        true,
                        false,
                        true,
                        new Guid("00000000-0000-0000-0000-000000000000"),
